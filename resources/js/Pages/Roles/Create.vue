    ...
    <AuthenticatedLayout>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="flex flex-col bg-white border shadow-sm rounded-xl">
                <div
                    class="bg-gray-100 border-b rounded-t-xl py-3 px-4 md:py-4 md:px-5 grid lg:grid-cols-2 gap-4"
                >
                    <h3 class="mt-1 text-gray-500">Crear Rol</h3>
            ...
            <div
                class="col-span-2 flex flex-col bg-white border shadow-sm rounded-xl"
            >
